...
translations = {
    "it": {"logout": "Esci", "welcome": "Benvenuto Coach!", "tab_config": "Configurazione", "tab_physical": "Profilo Fisico & AI", "tab_ai": "Funzioni AI Elite", "tab_analytics": "Analisi & Report", "system_config": "Configurazione Sistema", "team_name": "Nome Squadra", "session_type": "Tipo Sessione", "brand_color": "Colore Brand", "data_source": "Sorgente Dati", "use_sample": "Usa dati di esempio (raccomandato)", "period_filter": "Filtro Periodo", "min_quality": "Qualita Minima", "max_speed": "Velocita Massima", "match": "Partita", "training": "Allenamento", "period": "Periodo", "full_session": "Sessione Completa"},
    "en": {"logout": "Logout", "welcome": "Welcome Coach!", "tab_config": "Configuration", "tab_physical": "Physical Profile & AI", "tab_ai": "AI Elite Features", "tab_analytics": "Analytics & Reports", "system_config": "System Configuration", "team_name": "Team Name", "session_type": "Session Type", "brand_color": "Brand Color", "data_source": "Data Source", "use_sample": "Use sample data (recommended)", "period_filter": "Period Filter", "min_quality": "Min Quality", "max_speed": "Max Speed Clip", "match": "Match", "training": "Training", "period": "Period", "full_session": "Full Session"}
}
